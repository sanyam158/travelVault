...
const DATE_INPUT_STYLE = { ...INPUT_STYLE, colorScheme: 'dark' as const }
...
export default function EditTripModal({ trip, open, onClose }: Props) {
  ...
  const removeCover = () => {
    setCoverFile(null)
    // If there was an object URL preview, revoke it
    if (coverPreview && coverPreview !== trip.cover_image_url) {
  ...
  const handleClose = () => {
    ...
    setTimeout(() => {
      ...
      setCoverFile(null)
      setCoverPreview(trip.cover_image_url)
      setError(null)
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (coverFile) {
        ...
        const path = `${trip.user_id}/covers/${crypto.randomUUID()}.${ext}`
      ...
      } else if (coverPreview === null && trip.cover_image_url) {
        ...
        >
          ...
          >
            ...
            <div className="flex items-start justify-between mb-6">
              ...
              <button
                onClick={handleClose}
                className="flex-shrink-0 ml-4 mt-1 w-8 h-8 rounded-full flex items-center justify-center"
                style={{
            ...
            <div className="space-y-4">
                ...
                {coverPreview ? (
                  ...
                  >
                    ...
                    >
                      ...
                      <path
                        d="M10 7V5a2 2 0 012-2h4a2 2 0 012 2v2"
                        stroke="#d4a574"
                        strokeWidth="1.5"
                      />
                    ...
                    >
                      Drop cover image or{' '}
                      <span style={{ color: '#d4a574', opacity: 0.8 }}>
                        click to upload
                      </span>
                    </p>
                  </div>
              ...
              <div
                ...
                style={{
                  ...
                  background: 'rgba(224,117,117,0.04)',
                }}
              >
                <p
                  style={{
                ...
                >
                  Delete this trip — removes all memories permanently.
                </p>
                {!confirmDelete ? (
                  <button
                    ...
                    style={{
                      fontFamily: 'var(--font-body)',
                      background: 'rgba(224,117,117,0.1)',
                      border: '1px solid rgba(224,117,117,0.3)',
                      color: '#e07575',
                    }}
                  >
                    Delete Trip
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      style={{
                        fontFamily: 'var(--font-body)',
                        background: loading
                          ? 'rgba(224,117,117,0.3)'
                          : 'rgba(224,117,117,0.85)',
                        color: '#fff',
